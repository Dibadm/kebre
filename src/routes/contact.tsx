        ...
        <div>
          ...
          <div className="mt-10 space-y-5 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div><div className="font-semibold">Email</div><div className="text-muted-foreground">info@kebreilike.com</div></div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div><div className="font-semibold">Office</div><div className="text-muted-foreground">Jimma, Southwestern Ethiopia</div></div>
            </div>
          </div>
        </div>
